...
public class CatalogApplication {
	...
	CommandLineRunner init(ItemServiceImpl itemService){
		return args -> {
			...
			// Item item2 = new Item(2, "Loose Working Pants", 46, 0, 5,"/assets/working-pants.png" );
			// Item item3 = new Item(3, "Jordan 1 Retro High", 215, 0, 5,"/assets/jordan-1-retro.png" );
			// Item item4 = new Item(4, "Slouchy Crew Socks", 12, 0, 5,"/assets/ugg-crew-socks.png" );
			// Item item5 = new Item(5, "Ducks Unlimited Hat", 25, 0, 5,"/assets/ducks-unlimited-hat.png" );
